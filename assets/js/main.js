(function ($) {
  ...
  function toggleDarkTheme() {
    ...
    if (isDarkTheme) {
      darktoggle.src = "assets/imgs/sun-icon.svg";
      home1bgimg.style.backgroundImage =
        "url('assets/imgs/background2.svg')";
    } else {
      darktoggle.src = "assets/imgs/moon-icon.svg";
      home1bgimg.style.backgroundImage = "url('assets/imgs/background1.svg')";
      home2bgimg.style.backgroundImage = "url('assets/imgs/background2.svg')";
    }
  }
